...
import static review.hairshop.common.response.ApiResponseStatus.SUCCESS;
...
public class ApiResponse<T> {
   ...
   public static ApiResponse success(){
       return new ApiResponse(SUCCESS.isSuccess(), SUCCESS.getCode(), SUCCESS.getMessage());
   }

   public static <T> ApiResponse<T> success(T result){
       return new ApiResponse<>(SUCCESS.isSuccess(), SUCCESS.getCode(), SUCCESS.getMessage(), result);
   }
